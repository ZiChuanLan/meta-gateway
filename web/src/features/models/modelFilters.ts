 ...
 *
 * `status` counts like any other filter — "enabled" is only the baseline the
 * list starts from, so picking anything else is a real narrowing. Search is
