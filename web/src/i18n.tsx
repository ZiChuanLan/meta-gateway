...
const en: Dict = {
  ...
  "ops.runtime.section.health": "Health & auto-recovery",
  ...
  "ops.runtime.progressiveCooldownHint":
    "Tiered penalties (10m/1h/24h by default) instead of exponential doubling; each success steps one tier down instead of clearing everything.",
  "ops.runtime.cooldownLevel2": "Level 2 cooldown (s, fail #2)",
  "ops.runtime.cooldownLevel2Hint":
    "Freeze duration after 2 consecutive failures.",
  "ops.runtime.cooldownLevel3": "Level 3 cooldown (s, fail #3)",
  "ops.runtime.cooldownLevel3Hint":
    "Freeze duration after 3 consecutive failures.",
  "ops.runtime.cooldownLevel4": "Level 4 cooldown (s, fail #4)",
  "ops.runtime.cooldownLevel4Hint":
    "Freeze duration after 4+ consecutive failures.",
  "ops.runtime.breakerCount": "Breaker fail count",
  "ops.runtime.breakerCountHint":
    "Consecutive failures before the member is disabled outright (re-enable from the model list).",
  "ops.runtime.section.server": "Server",
  "ops.runtime.retryTimes": "Retry times (RETRY_TIMES)",
  "ops.runtime.retryTimesHint":
    "Extra cross-channel attempts after a retryable failure.",
  ...
  "ops.runtime.checkinCronHint":
    "Schedule expression. 0 8 * * * = every day at 08:00.",
...
const zh: Dict = {
  ...
  "ops.runtime.section.health": "健康与自动恢复",
  ...
  "ops.runtime.progressiveCooldownHint":
    "按档位惩罚（默认 10 分钟/1 小时/24 小时）替代指数翻倍；每次成功降一档，而不是一次成功全部清零。",
  "ops.runtime.cooldownLevel2": "第 2 档冷却（秒，第 2 次失败）",
  "ops.runtime.cooldownLevel2Hint": "连续失败 2 次后的冻结时长。",
  "ops.runtime.cooldownLevel3": "第 3 档冷却（秒，第 3 次失败）",
  "ops.runtime.cooldownLevel3Hint": "连续失败 3 次后的冻结时长。",
  "ops.runtime.cooldownLevel4": "第 4 档冷却（秒，第 4 次失败）",
  "ops.runtime.cooldownLevel4Hint": "连续失败 4 次及以上的冻结时长。",
  "ops.runtime.breakerCount": "断路器失败次数",
  "ops.runtime.breakerCountHint":
    "连续失败达到该次数后直接禁用成员（可在模型列表重新启用）。",
  ...
  "ops.runtime.cooldownHint":
    "失败后的基础冷却时间；连续失败会翻倍（上限 24 小时）。连续失败 3 次后自动禁用该成员，需在模型列表中手动重新启用。",
  "ops.runtime.checkinEnabled": "调度开关（CHECKIN_ENABLED）",
  "ops.runtime.checkinEnabledHint":
    "全局 cron 是否运行。单凭证定时仍在「连接」页开关。",
  "ops.runtime.checkinCron": "Cron（CHECKIN_CRON）",
  "ops.runtime.checkinCronHint": "定时表达式。0 8 * * * = 每天早上 8 点。",
