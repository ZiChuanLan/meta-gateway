...
const en: Dict = {
  ...
  "dashboard.balanceTrend": "Balance trend (14d)",
  "dashboard.balanceTrendHint": "Daily snapshots per channel",
  ...
  "cpa.kicker": "Extension",
  "cpa.title": "CLIProxyAPI",
  "cpa.description": "OAuth subscription account pool (ChatGPT Plus / Claude Pro / Grok) wired in as an upstream channel.",
  "cpa.statusTitle": "Service status",
  "cpa.statusHint": "meta-gateway never manages the CPA process; this page only probes it and wires it up.",
  "cpa.running": "Running",
  "cpa.notRunning": "Not running",
  "cpa.saveUrl": "Save",
  "cpa.guideTitle": "Start it locally:",
  "cpa.guideDownload": "Download",
  "cpa.guideRun": "Run the server (it listens on",
  "cpa.guideConfigure": "Configure your OAuth accounts in its UI, then",
  "cpa.channelTitle": "Upstream channel",
  "cpa.channelHint": "Creates an OpenAI-compatible channel pointing at CPA. Models are then configured on the Models page like any other channel.",
  "cpa.channelBody": "One click wires CPA into the gateway: it becomes a normal channel, so routing, cooldowns, logs, cost columns and alerts all apply. Its OAuth pool then serves requests like any other upstream.",
  "cpa.createChannel": "Create channel",
  "cpa.openChannels": "Open Connections",
  "cpa.channelCreated": "Channel created — configure models on the Connections page.",
...
const zh: Dict = {
  ...
  "dashboard.balanceTrend": "余额趋势（14 天）",
  "dashboard.balanceTrendHint": "各渠道每日快照",
  ...
  "cpa.kicker": "扩展",
  "cpa.title": "CLIProxyAPI",
  "cpa.description": "订阅 OAuth 账号池（ChatGPT Plus / Claude Pro / Grok）接入为上游渠道。",
  "cpa.statusTitle": "服务状态",
  "cpa.statusHint": "meta-gateway 不管理 CPA 进程；本页只探测其状态并接线。",
  "cpa.running": "运行中",
  "cpa.notRunning": "未运行",
  "cpa.saveUrl": "保存",
  "cpa.guideTitle": "本地启动方式：",
  "cpa.guideDownload": "下载",
  "cpa.guideRun": "运行服务（监听",
  "cpa.guideConfigure": "在其界面配置 OAuth 账号，然后",
  "cpa.channelTitle": "上游渠道",
  "cpa.channelHint": "创建一条指向 CPA 的 OpenAI 兼容渠道。模型之后在「模型」页像其他渠道一样配置。",
  "cpa.channelBody": "一键把 CPA 接入网关：它会成为普通渠道，路由、冷却、日志、价格列和告警全部生效，OAuth 池像其他上游一样为请求服务。",
  "cpa.createChannel": "创建渠道",
  "cpa.openChannels": "打开连接页",
  "cpa.channelCreated": "渠道已创建——在连接页配置模型。",
