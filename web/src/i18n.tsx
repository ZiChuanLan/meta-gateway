...
const en: Dict = {
	...
	"dashboard.guideTitle": "Welcome to Meta Gateway",
	"dashboard.guideCopy": "Four steps to your first proxied request:",
	"dashboard.guideStep1": "Create a channel with an upstream API key",
	"dashboard.guideStep2": "Sync models from the channel",
	"dashboard.guideStep3": "Create a downstream key",
	"dashboard.guideStep4": "Send a request to /v1/chat/completions",
...
const zh: Dict = {
	...
	"dashboard.guideTitle": "欢迎使用 Meta Gateway",
	"dashboard.guideCopy": "四步完成第一个代理请求：",
	"dashboard.guideStep1": "创建渠道并填入上游 API 密钥",
	"dashboard.guideStep2": "从渠道同步模型",
	"dashboard.guideStep3": "创建下游密钥",
	"dashboard.guideStep4": "向 /v1/chat/completions 发送请求",
