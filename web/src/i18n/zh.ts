...
export const zh: Dict = {
  ...
  "modelChanges.hint":
    "按渠道比较成功同步的清单；疑似移除不代表模型全网下线。首次同步仅建立基线，失败不会产生移除记录。",
  ...
  "modelChanges.preserve":
    "只修改所选成员的上游映射；对外模型名、路由名及其他配置保持不变。不会根据名称自动判断最新版。",
  "modelChanges.cross": "选择其他渠道的模型",
  "modelChanges.crossWarning":
    "跨渠道替换会改变请求来源，可能影响价格、能力与凭证兼容性。请核对目标渠道。",
  ...
  "select.search": "搜索选项…",
  "select.custom": "自定义类型",
  "select.noMatches": "没有匹配的选项",
  "shell.workspace": "你的 AI 服务空间",
  "motion.entrance": "进入工作空间",
  "motion.opening": "开启工作空间",
  "motion.closing": "离开工作空间",
  "motion.caption": "连接模型，打开新的可能。",
  "motion.skip": "跳过动画",
  "motion.replay": "重播入场",
  "appearance.title": "外观",
  "appearance.styles": "选择你的工作空间",
  ...
  "appearance.paletteHint": "只调整品牌色，与界面主题、明暗模式相互独立。",
  "appearance.palette.default": "跟随主题",
  "appearance.palette.ocean": "深海",
  "appearance.palette.forest": "松柏",
  "appearance.palette.violet": "紫罗兰",
  "appearance.palette.ember": "落日",
  "appearance.palette.graphite": "石墨",
  "appearance.palette.sakura": "樱",
  "appearance.chrome.title": "自定义界面入口",
  "appearance.chrome.hint":
    "选择界面上显示哪些入口。关掉的入口仍可用命令面板（⌘K）或地址进入，随时能在这里重新打开。",
  "appearance.chrome.groupBar": "顶部栏",
  "appearance.chrome.groupNav": "导航",
  "appearance.chrome.navHint":
    "导航条里显示哪些页面（经典控制台在顶栏内，现代工作空间在左侧栏，手机上在抽屉里）。",
  "appearance.chrome.search": "搜索与命令",
  "appearance.chrome.searchHint": "顶栏的搜索按钮；隐藏后仍可用 ⌘K 唤起命令面板。",
  "appearance.chrome.update": "更新提醒",
  "appearance.chrome.updateHint": "有新版本镜像时在顶部栏提示。",
  "appearance.chrome.theme": "明暗切换",
  "appearance.chrome.themeHint": "一键在浅色与深色之间切换。",
  "appearance.chrome.language": "语言切换",
  "appearance.chrome.languageHint": "控制台自身的中文 / English 切换。",
  "appearance.chrome.reset": "恢复默认",
  "appearance.localHint":
    "主题与明暗偏好保存在当前浏览器，不影响其他管理员。切换主题会保留当前页面和填写内容。",
  "login.titleFirst": "一个入口，",
  "login.titleSecond": "连接你的 AI 世界。",
  "login.description": "在一个工作空间中，管理上游连接、模型路由与每一次请求。",
  "login.welcome": "欢迎回来",
  "login.hint": "使用管理令牌，进入你的工作空间。",
  "login.private": "仅管理员可访问此工作空间",
  "login.foundation": "自托管 · 多上游 · 透明转发",
  "shell.search": "搜索与命令",
  "shell.gatewayStatus": "网关状态",
  "shell.expandNav": "展开侧栏",
  "shell.collapseNav": "收起侧栏",
  "shell.section.gateway": "工作空间",
  "shell.section.activity": "探索与观测",
  "shell.section.manage": "管理",
  "shell.footer": "连接模型，专注创造。",
  "channels.details": "连接详情",
  "channels.listHint": "选择连接查看详情",
  "modelsPage.filters": "筛选",
  "modelsPage.filtersActive": "筛选 · {n}",
  "modelsPage.members": "路由成员",
  "logsPage.moreFilters": "精确筛选",
  "logsPage.histogramScope": "全站最新 {n} 条请求",
  "logsPage.histogramBucket": "{n} 次请求（占 {share}）",
  "common.dismiss": "关闭",
  "common.apply": "应用",
  ...
  "app.themeLight": "切换到浅色模式",
	...
	"app.updateDialogTitle": "更新到 {version}",
  ...
  "dashboard.recentRequests": "区间请求",
  "dashboard.recentRequestsHint": "所选时间区间内的请求数。",
  "dashboard.healthyChannels": "健康渠道",
  "dashboard.healthyChannelsHint": "已启用且探测无错误的渠道。",
  "dashboard.rangeCost": "区间成本",
  "dashboard.rangeCostHint": "所选时间区间内请求的估算费用。",
  "dashboard.successRate": "成功率",
  "dashboard.successRateHint": "所选时间区间内返回 2xx 的请求比例。",
  ...
  "dashboard.topModels": "模型用量排行",
  "dashboard.topModelsEmpty": "所选时间区间内没有模型流量。",
  "dashboard.colRequests": "请求",
  "dashboard.colTokens": "Tokens",
  "dashboard.colFailed": "失败",
  "dashboard.cacheRead": "缓存读取",
  "dashboard.cacheReadHint": "所选时间区间内命中缓存的提示词 tokens。",
  ...
  "dashboard.hourlyTraffic": "流量总览",
  "dashboard.hourlyDetail": "{label} 详情",
  "dashboard.chartBack": "返回总览",
  "dashboard.chartDetailGranularity": "每 10 分钟",
  "dashboard.chartDetailSummary": "该时段 {n} 次请求",
  "dashboard.chartTooltip": "{req} 请求 · {tok} token",
  "dashboard.chartTooltipFailed": "其中失败 {n}",
  "dashboard.chartLegendRequests": "请求",
  "dashboard.chartLegendTokens": "Token",
  "dashboard.chartLegendFailed": "失败",
  "dashboard.chartEmpty": "该时段暂无流量数据。",
  "dashboard.trendUp": "较上一周期上升",
  "dashboard.trendDown": "较上一周期下降",
  "dashboard.rangeTokens": "区间消耗 {n} tokens",
  "dashboard.granularity": "粒度 {unit}",
  ...
  "channels.bulkMode": "批量选择",
  "channels.bulkDone": "完成",
  "channels.bulkSelected": "已选 {n} 个连接",
  "channels.bulkSelectPage": "全选本页",
  "channels.bulkSelectOne": "选择 {name}",
  "channels.bulkSyncModels": "同步模型",
  "channels.bulkSyncDone": "模型同步完成：{ok}/{total} 成功",
  "channels.bulkStatusDone": "已更新 {ok}/{total} 个连接",
  "channels.bulkClear": "清除选择",
  ...
  "channels.testAction": "试调",
  "channels.testActionHint": "不接入路由，直接对该渠道的模型发起一次真实调用。",
  "channels.testDialog.title": "试调 · {name}",
  ...
  "channels.testDialog.stop": "停止",
  "channels.testDialog.progress": "已测 {done}/{total} · 通过 {ok} · 未通过 {fail}",
  "channels.testDialog.idle": "未测试",
  "channels.testDialog.testing": "测试中",
  "channels.testDialog.ok": "通过",
  "channels.testDialog.failed": "未通过",
  "channels.testDialog.test": "测试",
  "channels.testDialog.retest": "重测",
  "channels.testDialog.adopted": "已接入",
  "channels.testDialog.empty": "没有匹配的模型。",
  "channels.testDialog.noFailures": "当前没有未通过的模型。",
  ...
  "channels.modelsFilterLabel": "按启用状态筛选",
  "channels.modelsFilterHint": "按启用状态筛选模型",
  "channels.modelsFilterAll": "全部",
  "channels.modelsFilterEnabled": "已启用",
  "channels.modelsFilterDisabled": "已禁用",
  "channels.modelsFilterEmpty": "没有符合筛选条件的模型。",
  ...
  "channels.stat.missingKeyHint": "只看尚未配置可用 API Key 的连接",
  "channels.stat.attentionHint": "只看健康或配置状态需要检查的连接",
  ...
  "channels.apiKeysHint":
    "本站已启用的 Key 组成中继池：档位高的先用，同档位内轮流分摊；前面的都失败才轮到后面的。",
  ...
  "channels.keyTier": "池内档位",
  "channels.keyTierPreferred": "优先",
  "channels.keyTierPreferredHint": "优先档：总是先打这一档的 Key。",
  "channels.keyTierBalanced": "均衡",
  "channels.keyTierBalancedHint": "均衡档（默认）：同档位的 Key 轮流分摊请求。",
  "channels.keyTierBackup": "后备",
  "channels.keyTierBackupHint": "后备档：只有更高档位全部失败后才轮到它。",
  ...
  "channels.apiKeyUsedByConnection": "本渠道绑定",
  ...
  "modelsPage.metaImageEdit": "聊天图编辑",
  ...
  "modelPicker.empty": "没有找到模型",
  "modelPicker.selectedCount": "已选 {n}",
  "modelPicker.clearSelection": "清空选择",
  "modelPicker.remove": "移除 {name}",
  "modelPicker.channelFilter": "按渠道筛选",
  "modelPicker.allChannels": "全部渠道",
  "modelPicker.selectFiltered": "全选当前 {n} 项",
  "modelPicker.missingTitle": "{n} 个已选模型当前没有可用路由——可能已被重命名或删除？",
  "modelPicker.missingClear": "移除失效项 ({n})",
  "modelPicker.aliasBadge": "别名",
  "modelPicker.aliasTitle": "渠道别名——上游模型 {models} 对外使用的名字",
  "modelPicker.patternTitle": "由通配路由 {pattern} 展开得到",
  "modelPicker.disabledBadge": "路由已禁用",
  "modelPicker.channelsTitle": "可达渠道：{channels}",
  "keys.accessCol": "用途",
  "logsPage.kicker": "可观测性",
  "logsPage.detailKicker": "代理尝试",
  "logsPage.retried": "已重试",
  "logsPage.slowOnly": "仅慢请求(≥5s)",
  "logsPage.histogram": "延迟分布",
  "logsPage.histogramStats":
    "总数 {total} · 慢请求 {slow} · p50 {p50}ms · p95 {p95}ms · p99 {p99}ms",
  "logsPage.coverage": "取样覆盖",
  "logsPage.histogramCoverage": "区间内 {matched} 条 · 取样最新 {sample} 条",
  "logsPage.histogramCovered": "区间内 {matched} 条已全部纳入",
  "logsPage.histogramSlowShare": "慢请求占比",
  "logsPage.histogramEmpty": "该区间还没有请求记录。",
  "logsPage.rangeScope": "时间区间同时作用于延迟分布与下方日志列表",
  "logsPage.export": "导出 CSV",
  ...
  "modelsPage.bulkMode": "批量选择",
  "modelsPage.bulkDone": "完成",
  "modelsPage.bulkSelected": "已选 {n} 条路由",
  "modelsPage.bulkSelectPage": "全选本页",
  "modelsPage.bulkSelectOne": "选择 {model}",
  "modelsPage.bulkEnableSelected": "启用选中",
  "modelsPage.bulkDisableSelected": "停用选中",
  "modelsPage.bulkDeleteSelected": "删除选中",
  "modelsPage.bulkDeleteConfirm":
    "删除选中的 {n} 条模型路由？路由下的成员绑定也会一并删除，此操作不可撤销。",
  "modelsPage.bulkClear": "清除选择",
  "modelsPage.bulkRouteDone": "已更新 {ok}/{total} 条路由",
  "modelsPage.bulkDeleteDone": "已删除 {ok}/{total} 条路由",
	"modelsPage.col.upstream": "上游",
	"modelsPage.pluginModel": "插件提供",
	"modelsPage.pluginModelOpen": "查看插件",
  ...
  "modelsPage.probe.scope":
    "本次将探测 {channels} 个渠道 × {models} 个模型，共 {pairs} 次真实调用。",
  ...
  "modelsPage.unify.rule.account_prefix": "去掉账号前缀 [A] /【次】",
	"modelsPage.unify.rule.vendor_prefix": "去掉厂商前缀（如 deepseek-ai/ 或 cn:）",
  ...
  "store.kicker": "插件",
	...
	"store.hooksWarning":
		"拦截钩子可以看到经过匹配的请求内容（含提示词与回复），并以插件进程的权限改写它。只保留你信任的插件。",
	"store.hook.point.route": "选路",
	"store.hook.point.request": "请求改写",
  ...
  "plugins.config": "配置",
	...
	"plugins.showInNav": "显示在导航栏",
	"plugins.configSaved": "已保存",
	"plugins.modelNone": "不设置",
	"plugins.advancedFields": "高级设置（{count} 项）",
	"plugins.modelGroups.empty": "还没有场景，点下面的按钮加一个。",
	"plugins.modelGroups.namePlaceholder": "场景名，如 code",
	"plugins.modelGroups.hintPlaceholder": "这个场景包含什么（可选，写了判断更准）",
	"plugins.modelGroups.remove": "删除场景",
	"plugins.modelGroups.removeModel": "移除 {model}",
	"plugins.modelGroups.pickModel": "添加模型",
	"plugins.modelGroups.addModel": "+ 选择模型",
	"plugins.modelGroups.allPicked": "已全部选完",
	"plugins.modelGroups.addScenario": "添加场景",
	"plugins.modelGroups.usePresets": "用推荐场景开始",
	"plugins.modelGroups.noModels":
		"网关里还没有可路由的模型：先在「连接」建渠道、在「模型」建路由，这里才能选。",
  "plugins.configHint":
  ...
  "routing.imageEditShim": "聊天图片编辑兼容",
  "routing.imageEditShimHint":
    "开启后，带图聊天请求会转为图片编辑请求，并以聊天消息返回结果。仅对需要图片编辑接口的模型生效，默认关闭。",
  "routing.imageEditShimEnable": "允许聊天客户端调用图片编辑模型",
  ...
  "playground.suggest3": "写一个三行的 Python 函数，返回两个数的最大公约数。",
  "playground.you": "你",
  "playground.assistant": "模型",
  "playground.send": "发送",
  "playground.stop": "停止",
  "playground.clear": "清空对话",
  "playground.promptPlaceholder": "输入消息，⌘/Ctrl + Enter 发送…",
  "playground.promptHint": "⌘/Ctrl + Enter 发送",
  "playground.model": "模型",
  "playground.modelHint": "只列出可走 /v1/chat/completions 的路由模型",
  "playground.upstream": "上游连接",
  "playground.upstreamAuto": "自动（网关选路）",
  ...
  "playground.maxTokensHint": "默认 4096，上限 32768",
  "playground.temperature": "温度 temperature",
  "playground.topP": "核采样 top_p",
  "playground.useParam": "发送该参数",
  "playground.stream": "流式输出",
  "playground.streamHint": "关掉后改为一次性响应，用来区分是不是只有流式链路出问题",
  "playground.streamEnable": "逐字返回（stream）",
  "playground.copy": "复制",
  "playground.copied": "已复制",
  "playground.edit": "编辑",
  "playground.regenerate": "重新生成",
  "playground.delete": "删除这条",
  "playground.save": "保存",
  "playground.saveAndSubmit": "保存并重新发送",
  "playground.reasoning": "思考过程",
  "playground.latency": "{ms} 毫秒",
  "playground.stopped": "已停止",
  "playground.upstreamError": "上游返回 HTTP {status}",
  "playground.noContent": "上游返回 HTTP {status}，但没解析出内容。",
  "playground.unreadable": "读不到响应流，请重试。",
  "workbench.image.requestTitle": "请求",
  "workbench.image.resultTitle": "结果",
  "workbench.image.model": "模型",
  "workbench.image.modelHint": "只列出具备图像能力的路由模型",
  "workbench.image.upstream": "上游连接",
  "workbench.image.upstreamAuto": "自动（网关选路）",
  "workbench.image.upstreamHint": "指定连接可只验证该路径；自动与线上 /v1 规则一致。",
  "workbench.image.upstreamHintOne": "当前仅有一个连接提供此模型。",
  "workbench.image.mode": "模式",
  "workbench.image.modeAuto": "自动",
  "workbench.image.modeGenerate": "生成",
  "workbench.image.modeEdit": "编辑",
  "workbench.image.size": "尺寸",
  "workbench.image.sizeDefault": "上游默认",
  "workbench.image.prompt": "提示词",
  "workbench.image.promptPlaceholder": "描述你想要的画面或修改…",
  "workbench.image.refs": "参考图",
  "workbench.image.refsHint": "最多 {n} 张",
  "workbench.image.refsHintUnbounded": "数量未登记，按上游实际能力为准",
  "workbench.image.addRef": "添加图片",
  "workbench.image.maxImagesExceeded": "该模型最多接受 {n} 张参考图",
  ...
  "workbench.image.fileReadFailed": "无法读取「{name}」，请重新选择文件。",
  ...
  "workbench.image.run": "执行",
  "workbench.image.empty": "还没有结果",
  "workbench.image.latency": "耗时 {ms} ms",
  "workbench.image.channel": "渠道 {name}",
  ...
  "workbench.cap.kind": "类型",
  "workbench.cap.provider": "厂商",
  "workbench.cap.endpoints": "端点",
  "workbench.cap.endpointsHint": "逗号分隔，如 /v1/images/edits",
  "workbench.cap.formats": "请求编码",
  "workbench.cap.formatsHint": "json 或 multipart；grok 编辑器只认 json",
  "workbench.cap.maxImages": "参考图上限",
  "workbench.cap.source": "来源",
  "workbench.cap.notes": "备注",
  "workbench.cap.inputs": "输入类型",
  "workbench.cap.outputs": "输出类型",
  "workbench.cap.sizes": "可选尺寸",
  "workbench.cap.empty": "还没有登记的能力记录，未登记的模型由内置规则推断。",
  "workbench.cap.source.builtin": "内置",
  "workbench.cap.source.discovery": "发现",
  "workbench.cap.source.manual": "人工",
  "workbench.cap.source.catalog": "目录同步",
  "workbench.cap.catalog.sync": "从外部目录同步",
  "workbench.cap.catalog.title": "从公开模型目录同步",
  ...
  "workbench.cap.catalog.pricesOff": "单价保持手工维护",
  "workbench.cap.catalog.writeCapabilities": "写入能力",
  "workbench.cap.catalog.writeMetadata": "写入元数据",
  "workbench.cap.catalog.writePrices": "回填未设置的单价",
  ...
  "workbench.cap.catalog.groupMetadata": "模型元数据",
  "workbench.cap.catalog.groupPrices": "单价（每 1k token）",
  "workbench.cap.catalog.notFound": "目录中未收录",
  "workbench.cap.catalog.manualKept": "保留你的手工设置",
  "workbench.cap.catalog.noChange": "已是最新。",
  "workbench.cap.fieldStream": "流式",
  "workbench.cap.fieldTools": "工具调用",
  "workbench.cap.fieldJsonMode": "JSON 模式",
  "workbench.cap.fieldContext": "上下文窗口",
  "workbench.cap.fieldThinking": "推理能力",
  "workbench.cap.fieldVendor": "厂商",
  "workbench.cap.fieldPricePrompt": "输入单价",
  "workbench.cap.fieldPriceCompletion": "输出单价",
  "workbench.cap.fieldPriceCache": "缓存读取单价",
  "workbench.cap.kindChat": "对话",
  "workbench.cap.kindImageGen": "生图",
  "workbench.cap.kindImageEdit": "改图",
  "workbench.cap.kindVideo": "视频",
  "workbench.cap.kindEmbedding": "向量",
  "workbench.cap.kindTTS": "语音合成",
  "workbench.cap.kindSTT": "语音识别",
  ...
  "timeRange.preset1h": "1 小时",
  "timeRange.preset6h": "6 小时",
  "timeRange.preset24h": "24 小时",
  "timeRange.preset7d": "7 天",
  "timeRange.preset30d": "30 天",
  "timeRange.presetAll": "全部",
  "timeRange.custom": "自定义",
  "timeRange.from": "起始时间",
  "timeRange.to": "结束时间",
  "timeRange.invalid": "结束时间早于起始时间",
  "timeRange.reanchor": "对齐当前时间",
  "timeRange.openStart": "最早",
  "timeRange.openEnd": "现在",
};
