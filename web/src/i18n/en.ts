...
export const en: Dict = {
  ...
  "logsPage.histogramBucket": "{n} requests ({share})",
  ...
  "dashboard.recentRequestsHint": "Requests inside the selected time range.",
  "dashboard.healthyChannels": "Healthy channels",
  "dashboard.healthyChannelsHint": "Enabled channels without a probe error.",
  "dashboard.rangeCost": "Cost in range",
  "dashboard.rangeCostHint": "Estimated cost of requests in the selected range.",
  "dashboard.successRate": "Success rate",
  "dashboard.successRateHint": "2xx responses inside the selected range.",
  ...
  "dashboard.chartBack": "Back to overview",
  ...
  "dashboard.chartTooltipFailed": "{n} failed",
  "dashboard.chartLegendRequests": "Requests",
  "dashboard.chartLegendTokens": "Tokens",
  "dashboard.chartLegendFailed": "Failed",
  "dashboard.chartEmpty": "No traffic in this window yet.",
  "dashboard.trendUp": "higher than the previous period",
  "dashboard.trendDown": "lower than the previous period",
  "dashboard.rangeTokens": "{n} tokens in range",
  "dashboard.granularity": "{unit} buckets",
  "dashboard.unitMinute": "{n} min",
  "dashboard.unitHour": "{n} h",
  "dashboard.unitDay": "{n} d",
  "dashboard.noActivity":
    "No requests in the selected range yet — try the chat test panel on the Models page.",
  ...
  "channels.modelsFilterHint": "Filter models by enabled state",
  "channels.modelsFilterAll": "All",
  "channels.modelsFilterEnabled": "Enabled",
  "channels.modelsFilterDisabled": "Disabled",
  "channels.modelsFilterEmpty": "No models match the filter.",
  ...
  "modelPicker.selectedCount": "{n} selected",
  "modelPicker.clearSelection": "Clear selection",
  "modelPicker.remove": "Remove {name}",
  ...
  "modelPicker.patternTitle": "Expanded from wildcard route {pattern}",
  "modelPicker.disabledBadge": "route disabled",
  "modelPicker.channelsTitle": "Reachable via: {channels}",
  ...
  "logsPage.histogramStats":
    "total {total} · slow {slow} · p50 {p50}ms · p95 {p95}ms · p99 {p99}ms",
  "logsPage.coverage": "Coverage",
  "logsPage.histogramCoverage": "{matched} in window · newest {sample} sampled",
  "logsPage.histogramCovered": "all {matched} in window included",
  "logsPage.histogramSlowShare": "Slow share",
  "logsPage.histogramEmpty": "No requests recorded in this window.",
  "logsPage.rangeScope": "The time range applies to both the distribution and the log list below",
  ...
  "timeRange.preset1h": "1 hour",
  "timeRange.preset6h": "6 hours",
  "timeRange.preset24h": "24 hours",
  "timeRange.preset7d": "7 days",
  "timeRange.preset30d": "30 days",
  "timeRange.presetAll": "All time",
  "timeRange.custom": "Custom",
  "timeRange.from": "From",
  "timeRange.to": "To",
  "timeRange.invalid": "The end time is before the start time",
  "timeRange.reanchor": "Re-anchor to now",
  "timeRange.openStart": "earliest",
  "timeRange.openEnd": "now",
};
