...
export function ModernChrome({ navigation, version, theme, onThemeChange, onSearch, onDisconnect, health, tone, update, collapsed, onCollapse, onOpenNav, sectionLabel, pageLabel }: ThemeChromeProps) {
  const { t } = useI18n();
  // Which controls the operator keeps in the chrome (Settings → Appearance).
  ...
  return <>
    ...
    <header className="console-topbar">
      ...
      <div className="console-global-actions">
        ...
        {topBar.search ? <IconButton className="console-mobile-search" label={t("command.placeholder")} onClick={onSearch}><Search size={17} /></IconButton> : null}
